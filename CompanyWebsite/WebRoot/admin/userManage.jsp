                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/userManageAction_queryUser.action" method="post">
                                    <div class="col-lg-5 form-group">
                                        <label class="col-lg-4 control-label" for="query_ano">会员用户名</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="query_ano" type="text" id="username" name="username">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <s:iterator value="#request.pb.beanList" var="user">
                             <tbody>
	                         	   <td><s:property value="#user.username"/></td>
	                                <td><s:property value="#user.pwd"/></td>
	                                <td>
	                                	<button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#updateModal" onclick="updateUser(<s:property value="#user.userId"/>)">修改</button>
	                                	<button type="button" class="btn btn-danger btn-xs" onclick="deleteUser(<s:property value="#user.userId"/>)">删除</button>
